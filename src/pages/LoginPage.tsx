        ...
        <div className="relative grid gap-9 lg:grid-cols-[0.92fr_0.78fr] lg:items-center">
          <div>
            <h1 className="max-w-4xl text-5xl font-semibold leading-[1.08] tracking-[-0.04em] text-ink md:text-6xl xl:text-7xl">
              Welcome back to EdgeTrace.
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-7 text-muted md:text-lg md:leading-8">
              Access your reports, comparisons, strategy sets, and diagnostic workflows.
            </p>
            <div className="mt-8 grid max-w-xl gap-3">
              {[
                "Completed-trade diagnostics",
                "Attribution and comparison workflows",
                "Strategy monitoring"
              ].map((item) => (
            ...
            {nextPath && (
              <p className="mt-7 border-l border-cyan/70 pl-4 text-sm leading-6 text-muted">
